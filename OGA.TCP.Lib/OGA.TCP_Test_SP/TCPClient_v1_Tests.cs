    ...
    public class TCPClient_v1_Tests : OGA.Testing.Lib.Test_Base_abstract
    {
        ...
        public async Task Test_1_2_4()
        {
            ...
            try
            {
                ...
                // Send client config to the log...
                OGA.SharedKernel.Logging_Base.Logger_Ref?.Debug(wss.ToLogString_Config());
                // Send server endpoint config to the log...
                OGA.SharedKernel.Logging_Base.Logger_Ref?.Debug(_wsl.ServerSide_TCPEndpoint.ToLogString_Config());
